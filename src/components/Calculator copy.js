...
import {
  ...
  TextInput,
  StatusBar,
  Dimensions, Button, TouchableWithoutFeedback, TouchableOpacity
} from 'react-native';
...
arv: 200000,
    rehabCost: 10000,
    closingCosts: 0,
    closingCostsPercentage: .09,
    carryingCosts: 0,
    carryingCostsPercentage: .06,
    desiredProfit: 0,
    desiredProfitPercentage: .2,
    wholesaleFee: 15000,
    buyPrice: 0,
    offer: 0,
            index : 0,
        ...
        <View style={styles.picker}>
          ...
          <Picker  
            ...
            onSelect={(value,index) => {
                ...
                this.setState({source: value, sourceIndex: index, selectedSourceID: this.props.sttIDs[index]})
            }}
          />

          <Text style={styles.doneBtn} onPress={()=> [this.props.doneSelectSource(this.state.source,
            this.state.sourceIndex,this.state.destination,this.state.selectedSourceID),
            this.props.updateDestinations(this.state.selectedSourceID)]}>Done</Text>
         </View>
        )
    }
            ...
            <View style={styles.container}>
                <ScrollView>
                    ...
                    <TextInput style={styles.inputTxt} 
                        ...
                        >${this.getDecimal(this.props.arv)}</TextInput>
                    ...
                    <TextInput style={styles.inputTxt2} 
                        ...
                        onBlur={()=>this.props.calculateOffer("rehabCost",this.state.rehabCost)} 
                      >${this.getDecimal(this.props.rehabCost)}</TextInput>
                    <View style={styles.separator}/>

                    <Text style={styles.headerLbl}>Estimated Closing Costs</Text>

                    <View style={styles.doubleView}>
                        <TextInput style={styles.inputTxt3} 
                        onChangeText={(text) => this.setState({closingCosts: text})}
                        onBlur={()=>this.props.calculateOffer("closingCosts",this.state.closingCosts)} 
                      >${this.getDecimal(this.props.closingCosts)}</TextInput>


                        {/* <TextInput style={[styles.subscript]}>9%</TextInput> */}

                        <TextInput style={styles.subscript} 
                        onChangeText={(text) => this.setState({closingCostsPercentage: text})}
                        onBlur={()=>this.props.calculateOffer("closingCostsPercentage",this.state.closingCostsPercentage)} 
                      >{this.getPercentage(this.props.closingCostsPercentage)}%</TextInput>
                    ...
                    <View style={styles.doubleView}>
                        ...
                        onBlur={()=>this.props.calculateOffer("carryingCosts",this.state.carryingCosts)} 
                      >${this.getDecimal(this.props.carryingCosts)}</TextInput>

                        {/* <TextInput style={[styles.subscript]}>6%</TextInput> */}

                        <TextInput style={styles.subscript} 
                        onChangeText={(text) => this.setState({carryingCostsPercentage: text})}
                        onBlur={()=>this.props.calculateOffer("carryingCostsPercentage",this.state.carryingCostsPercentage)} 
                      >{this.getPercentage(this.props.carryingCostsPercentage)}%</TextInput>
                    ...
                    <View style={styles.doubleView}>
                        ...
                        onBlur={()=>this.props.calculateOffer("desiredProfit",this.state.desiredProfit)} 
                      >${this.getDecimal(this.props.desiredProfit)}</TextInput>

                        {/* <TextInput style={[styles.subscript]}>20%</TextInput> */}

                        <TextInput style={styles.subscript} 
                        onChangeText={(text) => this.setState({desiredProfitPercentage: text})}
                        onBlur={()=>this.props.calculateOffer("desiredProfitPercentage",this.state.desiredProfitPercentage)} 
                      >{this.getPercentage(this.props.desiredProfitPercentage)}%</TextInput>
                    ...
                    onChangeText={(text) => this.setState({wholesaleFee: text})}
                        onBlur={()=>this.props.calculateOffer("wholesaleFee",this.state.wholesaleFee)} 
                      >${this.getDecimal(this.props.wholesaleFee)}</TextInput>
                    <View style={styles.separator}/>

                    <Text style={styles.headerLbl}>Buy Price for House</Text>
                    <TextInput style={styles.inputTxt2} 
                    onChangeText={(text) => this.setState({buyPrice: text})}
                        onBlur={()=>this.props.calculateOffer("buyPrice",this.state.buyPrice)} 
                      >${this.getDecimal(this.props.buyPrice)}</TextInput>
                    <View style={styles.separator}/>

                    <Text style={styles.headerLbl}>Max Offer</Text>
                    <TextInput style={styles.inputTextBold} 
                    onChangeText={(text) => this.setState({offer: text})}
                        onBlur={()=>this.props.calculateOffer("offer",this.state.offer)} 
                      >${this.getDecimal(this.props.offer)}</TextInput>
                    <View style={styles.separator}/>

                    <Text style={[styles.offerBtn]} onPress={()=> this.createOffer()} >CREATE OFFER</Text>
...
export default connect(mapStateToProps,{calculateOffer})(Calculator);
